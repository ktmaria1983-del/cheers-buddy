...
<section className="max-w-4xl mx-auto mt-16 mb-24 text-center animate-fadeIn">
  ...
  <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mx-auto mb-6">
    ...
    <span className="text-white font-semibold">
      most people don’t need judgement, pressure, or comparison — they need encouragement.
    </span>
    They need someone to notice their progress, no matter how small. Someone to say:
    “Yes, this matters. Keep going.”
  </p>

  <p className="text-slate-400 text-base leading-relaxed max-w-3xl mx-auto mb-6">
    ...
    perfection more than honest attempts.
    CheerBuddy flips that script entirely.
  </p>
  ...
  <p className="text-slate-400 text-base leading-relaxed max-w-3xl mx-auto">
    ...
    shaped every part of this platform. The vision is simple:
    create a place where humanity returns to the centre, where progress is honoured,
    and where every step forward is worthy of a cheer.
  </p>
</section>
