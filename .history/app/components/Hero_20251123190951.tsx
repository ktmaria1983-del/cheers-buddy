...
export default function Hero() {
  ...
  relative rounded-none md:rounded-3xl
  ...
  className="rounded-2xl border border-white/10 bg-slate-800/50 px-6 py-3 
             hover:bg-slate-700/50 transition cursor-pointer w-full text-left flex items-center gap-2"
>
