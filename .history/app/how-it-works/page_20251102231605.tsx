  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-20 text-slate-100">
      <section className="text-center space-y-6">
        <h1 className="text-5xl md:text-6xl font-extrabold gradient-text animate-shimmer">
          How Cheers Buddy Works
        </h1>

        <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto">
          Cheers Buddy is a warm space where real people celebrate real progress.
          We don’t measure success in money — we measure it in{" "}
          <span className="text-amber-300 font-semibold">cheers</span>.
        </p>
      </section>
      ...
      <section className="mt-12 grid gap-8 md:grid-cols-3 text-center">
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-800/40 p-6">
          <h3 className="text-xl font-bold text-fuchsia-400 mb-3">Feel Momentum</h3>
          <p>Every cheer is a reminder that growth is noticed. Consistency becomes easier.</p>
        </div>
      </section>
