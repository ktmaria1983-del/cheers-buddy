...
// was: import NavBar from "@/components/NavBar";
import NavBar from "./components/NavBar";
// formats a UTC date string like "2025-11-01T12:34:56Z" into something readable
...
export default function Home() {
  ...
  className="w-full rounded-xl border border-white/10 bg-slate-900/70 text-slate-100 text-lg font-semibold px-4 py-3 focus:outline-none focus:ring-2 focus:ring-sky-400/50"
              ...
              >
                ...
                <footer className="mt-4 flex items-center justify-between">
                  <button
                    ...
                    className={`relative overflow-visible inline-flex items-center gap-2 rounded-xl border border-white/10 bg-slate-800 px-4 py-2 text-slate-100 transition-all duration-700 group-hover:bg-right select-none ${
