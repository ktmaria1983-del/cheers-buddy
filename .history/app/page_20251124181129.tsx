...
useEffect(() => {
  ...
  className="mx-auto mt-6 block rounded-2xl
             bg-gradient-to-r from-sky-400 via-blue-500 to-purple-500
             px-8 py-3 text-white font-semibold text-lg
...
<button
  id="back-to-top"
  onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
  className="fixed bottom-6 right-6 z-[9999] h-14 w-14
             rounded-full bg-gradient-to-br from-sky-400 via-blue-500 to-purple-600
