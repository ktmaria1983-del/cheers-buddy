...
useEffect(() => {
  function onScroll() {
    ...
    if (!btn) return; // ← TypeScript is happy now
  ...
  className="fixed bottom-6 right-6 z-[9999] h-14 w-14 rounded-full bg-gradient-to-br from-[#f68cff] via-[#ffd48a] via-[#f6ff8c] to-[#05f2b5] shadow-[0_0_15px_rgba(255,255,255,0.45)] text-black text-2xl flex items-center justify-center transition-all duration-300 opacity-0 pointer-events-none hover:scale-[1.07]"
>
  ↑
</button>
