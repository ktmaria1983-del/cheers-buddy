...
return (
  <main 
    className="
      ...
      h-screen 
      overflow-y-scroll 
      max-w-3xl mx-auto px-6 py-20 space-y-20
    "
  >
    {/* HERO SECTIONS */}
      <>
...
<section
  id="post-win"
  className="scroll-mt-40 rounded-3xl p-[2px] mx-auto mt-32 
             bg-gradient-to-r from-[#ff9aea] via-[#ffd78a] to-[#6fffc2]
             shadow-[0_0_35px_rgba(255,255,255,0.25)]
             max-w-3xl w-full"
>
  <div className="rounded-3xl bg-[#0f0f16]/80 backdrop-blur-xl p-10 space-y-8">
    ...
    <label className="block space-y-1">
      ...
      <input
        className="w-full rounded-xl bg-slate-900/60 border border-white/10
    ...
    <label className="block space-y-1">
      ...
      <textarea
        rows={4}
        className="w-full rounded-2xl bg-slate-900/60 border border-white/10
                   px-4 py-3 text-white placeholder-slate-400
                   focus:ring-2 focus:ring-[#ffd78a] outline-none"
        value={details}
