...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* BRAND INTRO */}
      <section className="text-center space-y-3 snap-start">
      ...
      <section
        id="post-win"
        className="
          snap-start scroll-mt-40
          rounded-3xl p-[2px] mx-auto mt-32
      ...
      {/* BUTTON B (FAB floating) */}
      <button
        id="back-to-top"
        onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
        className="
          fixed bottom-6 right-6 z-[9999]
          h-14 w-14 rounded-full text-black text-2xl
